    ...
    try {
      ...
      SendEmailRequest request =
          new SendEmailRequest()
              .withReplyToAddresses(reservation.getUser().getUserMail())
  ...
  static String generateHtmlTextMessage(final RoomReservation reservation) {
    Object[] params =
        new Object[] {
          ...
          reservation.getUser().getUserMail(),
          reservation.getBuilding(),
          reservation.getDay(),
          reservation.getTime(),
          reservation.getDuration(),
          reservation.isVcRequired()
        };
    return MessageFormat.format(
        "<h3>Hello Stefan,</h3><br />"
            ...
            + "<br />"
            + "Best regards,<br />"
            + "<i>The room reservation service</i>",
        params);
  }
}
